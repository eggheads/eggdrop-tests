...
skip
  sed -i '/set ssl-certificate/c\set ssl-certificate \"eggdropz.crt\"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-privatekey/c\set ssl-privatekey \"eggdropz.key\"' $HOME/eggdrop_ssl_config.conf
...
@test "Eggdrop dies if user-specified .key file is missing/incorrect" {
  sed -i '/set ssl-certificate/c\set ssl-certificate \"eggdrop.crt\"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-privatekey/c\set ssl-privatekey \"sdfsdf.key\"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop eggdrop_ssl_config.conf
  echo $output
...
@test "Eggdrop dies if user-specified .crt file is missing/incorrect" {
  sed -i '/set ssl-certificate/c\set ssl-certificate \"sdfsdf.crt\"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-privatekey/c\set ssl-privatekey \"eggdrop.key\"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop eggdrop_ssl_config.conf
...
@test "Eggdrop runs if SSL .key and .crt file are set to \"\"" {
  sed -i '/set ssl-certificate/c\set ssl-certificate \"\"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-privatekey/c\set ssl-privatekey \"\"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop eggdrop_ssl_config.conf
  [ $status -eq 0 ]
}
...
@test "Eggdrop dies if key file empty" {
  touch badkey.key
  sed -i '/set ssl-privatekey/c\set ssl-privatekey \"badkey.key\"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-certificate/c\set ssl-certificate \"eggdrop.crt\"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop eggdrop_ssl_config.conf
  rm badkey.key
...
@test "Eggdrop dies if key/crt file do not match" {
  sed -i '/set ssl-privatekey/c\set ssl-privatekey \"eggdrop_ssl_config.badpair.key\"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-certificate/c\set ssl-certificate \"eggdrop.crt\"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop eggdrop_ssl_config.conf
  echo $output
...
@test "Eggdrop disconnects on no matching protocols" {
  sed -i '/set ssl-protocols/c\set ssl-protocols "GEO"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-privatekey/c\set ssl-privatekey \"eggdrop.key\"' $HOME/eggdrop_ssl_config.conf
...
# Freenode offers 1.0 and 1.2
  sed -i '/set ssl-protocols/c\set ssl-protocols "TLSv1 TLSv1.1 TLSv1.2 TLSv1.3"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop -nt eggdrop_ssl_config.conf
  ssltext=${output}
  echo ${ssltext}
...
@test "Eggdrop chooses proper SSL/TLS protocol, Eggdrop same as server" {
  sed -i '/set ssl-protocols/c\set ssl-protocols "TLSv1 TLSv1.1 TLSv1.2"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop -nt eggdrop_ssl_config.conf
  ssltext=${output}
  echo ${ssltext}|grep "TLS: cipher used:"| grep TLSv1.2;
  [ $status -eq 0 ]
...
@test "Eggdrop chooses proper SSL/TLS protocol, Eggdrop lower than server" {
  sed -i '/set ssl-protocols/c\set ssl-protocols "TLSv1 TLSv1.1"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop -nt eggdrop_ssl_config.conf
  ssltext=${output}
...
@test "Eggdrop uses specified SSL/TLS cipher" {
  sed -i '/set ssl-ciphers/c\set ssl-ciphers "ECDHE-RSA-AES256-SHA"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop -nt eggdrop_ssl_config.conf
  ssltext=${output}
...
@test "Eggdrop disconnects on required cipher stronger than supported protocol" {
  sed -i '/set ssl-protocols/c\set ssl-protocols "TLSv1"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-ciphers/c\set ssl-ciphers "ECDHE-RSA-AES256-GCM-SHA384"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop -nt eggdrop_ssl_config.conf
  ssltext=${output}
  echo $output
...
@test "Eggdrop disconnects on required cipher weaker/disallowed by supported protocol" {
  sed -i '/set ssl-protocols/c\set ssl-protocols "TLSv1.2"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-ciphers/c\set ssl-ciphers "TLS_RSA_WITH_AES_128_CBC_SHA"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop -nt eggdrop_ssl_config.conf
  ssltext=${output}
  echo $output
  echo ${ssltext}|grep "SSL routines:ssl_cipher_list_to_bytes:no ciphers available"
...
@test "Eggdrop warns on incorrect DHParam file" {
  sed -i '/set ssl-protocols/c\set ssl-ciphers "DEFAULT"' $HOME/eggdrop_ssl_config.conf
  sed -i '/set ssl-dhparam/c\set ssl-dhparam "foo.pem"' $HOME/eggdrop_ssl_config.conf
  run ./eggdrop -nt eggdrop_ssl_config.conf
  ssltext=${output}
  echo ${output}
